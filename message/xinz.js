...
let antihoax = JSON.parse(fs.readFileSync('./database/antihoax.json'));
...
module.exports = async(xinz, msg, blocked, baterai, _afk, welcome, left) => {
    try {
        ...
        const isAntiHoax = isGroup ? antihoax.includes(from) : false
     ...
     thumbnail: fs.readFileSync(setting.pathImg)
        ...
        if (isGroup && isAntiLink && !isOwner && !isGroupAdmins && isBotGroupAdmins){
            if (chats.match(/(https:\/\/chat.whatsapp.com)/gi)) {
                ...
                xinz.toggleDisappearingMessages(from)
                reply(`*「 GROUP LINK DETECTED 」*\n\nSepertinya kamu mengirimkan link grup, maaf kamu akan di kick`)
                xinz.sendMessage(from, `*Pembersihan !* \n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n*Jangan ke atas kak______________________*`, text, { quoted: msg })
                xinz.sendMessage(from, `*Pembersihan !* \n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n*Jangan ke atas kak______________________*`, text, { quoted: msg })
                xinz.sendMessage(from, `*Tap Tahan Grup Dan tandai telah di baca_____* \n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n*Tap Tahan Grup Dan tandai telah di baca_____*`, text, { quoted: msg })
            }
        }
        // Anti wame
        ...
        if (isGroup && isAntiVirtex && !isOwner && !isGroupAdmins && isBotGroupAdmins){
        	if (chat.match(/(๒\/)/gi)) {
        	    xinz.groupRemove(from, [sender])
                xinz.toggleDisappearingMessages(from)
        	    reply(`*「 VIRTEXT DETECTED 」*\n\nSepertinya kamu mengirimkan virtext, maaf kamu akan di kick`)
                xinz.sendMessage(from, `*Pembersihan !* \n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n*Jangan ke atas kak______________________*`, text, { quoted: msg })
                xinz.sendMessage(from, `*Pembersihan !* \n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n*Jangan ke atas kak______________________*`, text, { quoted: msg })
                xinz.sendMessage(from, `*Tap Tahan Grup Dan tandai telah di baca_____* \n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n*Tap Tahan Grup Dan tandai telah di baca_____*`, text, { quoted: msg })
            }
        ...
        // Anti hoax
        if (isGroup && isAntiHoax && !isOwner && !isGroupAdmins && isBotGroupAdmins){
        	if (chat.match(/(bagikan\/)/gi)) {
                xinz.groupRemove(from, [sender])
                xinz.toggleDisappearingMessages(from)
                reply(`*「 HOAX DETECTED 」*\n\nSepertinya kamu mengirim hoax, maaf kamu akan di kick`)
                xinz.sendMessage(from, `*Pembersihan !* \n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n*Jangan ke atas kak______________________*`, text, { quoted: msg })
                xinz.sendMessage(from, `*Pembersihan !* \n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n*Jangan ke atas kak______________________*`, text, { quoted: msg })
                xinz.sendMessage(from, `*Tap Tahan Grup Dan tandai telah di baca_____* \n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n*Tap Tahan Grup Dan tandai telah di baca_____*`, text, { quoted: msg })
            }
        ...
        switch(command){
            case 'prefix': case 'cekprefix':{
                textImg(`Prefix/Awalan bot adalah : ${prefix}\nSilakan ketik ${prefix}menu untuk melihat list menu bot`)
            }
                break
...
//------------------< Sticker / Tools >-------------------
            case prefix+'exif':{
				...
				await reply('Berhasil menyimpan exif\nMulai sekarang semua yang menggunakan fitur sticker memakai wm ini!')
            }
				break
            case prefix+'sticker':
            case prefix+'stiker':
...
//------------------< NULIS >---------------------
            ...
            case prefix+'nuliskiri':{
                ...
                .on('exit', () => {
                    xinz.sendMessage(from, fs.readFileSync('./media/nulis/images/buku/setelahkiri.jpg'), image, {quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi`, thumbnail: Buffer.alloc(0)})
                    limitAdd(sender, limit)
                })
            }
                break
            case prefix+'nuliskanan':{
                ...
                .on('error', () => reply(mess.error.api))
                .on('exit', () => {
                    xinz.sendMessage(from, fs.readFileSync('./media/nulis/images/buku/setelahkanan.jpg'), image, {quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi`, thumbnail: Buffer.alloc(0)})
                    limitAdd(sender, limit)
                })
            }
                break
            case prefix+'foliokiri':{
                ...
                .on('error', () => reply(mess.error.api))
                .on('exit', () => {
                    xinz.sendMessage(from, fs.readFileSync('./media/nulis/images/folio/setelahkiri.jpg'), image, {quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi`, thumbnail: Buffer.alloc(0)})
                    limitAdd(sender, limit)
                })
            }
                break
            case prefix+'foliokanan':{
                ...
                .on('error', () => reply(mess.error.api))
                .on('exit', () => {
                    xinz.sendMessage(from, fs.readFileSync('./media/nulis/images/folio/setelahkanan.jpg'), image, {quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi`, thumbnail: Buffer.alloc(0)})
                    limitAdd(sender, limit)
                })
            }
                break
//------------------< Text Maker >-------------------
            case prefix+'harta': case prefix+'hartatahta': case prefix+'tahta':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                if (args.length < 2) return reply(`Penggunaan ${command} text\n\nContoh : ${command} CeriaBot`)
                reply(mess.wait)
                xinz.sendImage(from, await getBuffer(`https://api.zeks.xyz/api/hartatahta?text=${args[1]}&apikey=OKW7NC1B5b8ujzCaocblcsF95ba`), '', msg).catch(() => reply(mess.error.api))
                limitAdd(sender, limit)
                }
                break
            case prefix+'video1':
                ...
                if (args.length < 2) return reply(`Penggunaan ${command} text\n\nContoh : ${command} CeriaBot`)
                reply(mess.wait)
                const video1 = await getBuffer(`https://api.xteam.xyz/videomaker/poly?text=${body.slice(8)}&APIKEY=genbotkey`)
                xinz.sendMessage(from, video1, video, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
            break
            case prefix+'video2':
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                if (args.length < 2) return reply(`Penggunaan ${command} text\n\nContoh : ${command} CeriaBot`)
                reply(mess.wait)
                const video2 = await getBuffer(`https://api.xteam.xyz/videomaker/bold?text=${body.slice(8)}&APIKEY=genbotkey`)
                xinz.sendMessage(from, video2, video, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
            break
            case prefix+'video3':
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                if (args.length < 2) return reply(`Penggunaan ${command} text\n\nContoh : ${command} CeriaBot`)
                reply(mess.wait)
                const video3 = await getBuffer(`https://api.xteam.xyz/videomaker/glowing?text=${body.slice(8)}&APIKEY=genbotkey`)
                xinz.sendMessage(from, video3, video, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
            break
            case prefix+'video4':
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                if (args.length < 2) return reply(`Penggunaan ${command} text\n\nContoh : ${command} CeriaBot`)
                reply(mess.wait)
                const video4 = await getBuffer(`https://api.xteam.xyz/videomaker/colorful?text=${body.slice(8)}&APIKEY=genbotkey`)
                xinz.sendMessage(from, video4, video, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
            break
            case prefix+'video5':
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                if (args.length < 2) return reply(`Penggunaan ${command} text\n\nContoh : ${command} CeriaBot`)
                reply(mess.wait)
                const video5 = await getBuffer(`https://api.xteam.xyz/videomaker/army?text=${body.slice(8)}&APIKEY=genbotkey`)
                xinz.sendMessage(from, video5, video, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
            break
            case prefix+'video6':
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                if (args.length < 2) return reply(`Penggunaan ${command} text\n\nContoh : ${command} CeriaBot`)
                reply(mess.wait)
                const video6 = await getBuffer(`https://api.xteam.xyz/videomaker/retro?text=${body.slice(8)}&APIKEY=genbotkey`)
                xinz.sendMessage(from, video6, video, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
            break
//>>> TEXT PRO ME
            case prefix+'barcode':
            case prefix+'naruto':
            ...
            case prefix+'flowertext':
            case prefix+'crosslogo':
            case prefix+'silktext':
            case prefix+'flametext':
            case prefix+'glowtext':
            case prefix+'smoketext':
            case prefix+'skytext':
            case prefix+'cslogo':
            case prefix+'lithgtext':
            case prefix+'crismes':
            case prefix+'tfire':
            case prefix+'sandw':
            case prefix+'epep':
            ...
            case prefix+'text3dbox':
            case prefix+'text3d':
            case prefix+'logobp':
            case prefix+'leavest':
            case prefix+'thundertext':
            case prefix+'tlight':
            case prefix+'qrcreator':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                if (args.length < 2) return reply(`Penggunaan ${command} text\n\nContoh : ${command} CeriaBot`)
                reply(mess.wait)
                const who = await getBuffer(`https://api.zeks.me/api/${command.slice(1)}?apikey=OKW7NC1B5b8ujzCaocblcsF95ba&text=${args[1]}`)
                xinz.sendMessage(from, who, image, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
                limitAdd(sender, limit)
                }
                break
//>>> PHOTOOXY
            case prefix+'pubglogo':
            case prefix+'snowwrite':
            case prefix+'watercolour':
            case prefix+'logoaveng':
            case prefix+'phlogo':
            case prefix+'marvellogo':
            case prefix+'gtext':
            case prefix+'wolflogo':{
            	if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                if (args.length < 2) return reply(`Penggunaan ${command} text1|text2\n\nContoh : ${command} Ceria|Bot`)
                if (!q.includes("|")) return reply(`Penggunaan ${command} text1|text2\n\nContoh : ${command} Ceria|Bot`)
                reply(mess.wait)
                const wolf = await getBuffer(`https://api.zeks.me/api/${command.slice(1)}?apikey=OKW7NC1B5b8ujzCaocblcsF95ba&text1=${q.split("|")[0]}&text2=${q.split("|")[1]}`)
                xinz.sendMessage(from, wolf, image, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
                limitAdd(sender, limit)
                }
                break
            case prefix+'retrotext':
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                if (args.length < 2) return reply(`Penggunaan ${command} text1|text2|text3\n\nContoh : ${command} Ceria|Bot|Jaya`)
                if (!q.includes("|")) return reply(`Penggunaan ${command} text1|text2|text3\n\nContoh : ${command} Ceria|Bot|Jaya`)
                reply(mess.wait)
                const emot = await fetchJson(`https://api.zeks.me/api/retro?apikey=OKW7NC1B5b8ujzCaocblcsF95ba&text1=${q.split("|")[0]}&text2=${q.split("|")[1]}&text3=${q.split("|")[2]}`)
                const ngebuff = await getBuffer(emot.result)
                xinz.sendMessage(from, ngebuff, image, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
                limitAdd(sender, limit)
                break
//------------------< Math Random >-------------------
				case prefix+'ganteng':
				...
				case prefix+'cantik':
					...
					var aku = cinta[Math.floor(Math.random() * kamu.length)]
					var cintax = kamu[Math.floor(Math.random() * cinta.length)]
					let vejs = `*@${aku.jid.split('@')[0]}* ♥️ @${cintax.jid.split('@')[0]}`
...
//------------------< Random >---------------------
				...
				case prefix+'katailham':
				    ...
				    xinz.sendMessage(from, ''+su+'\n\n_-Ilham._', text, { quoted: msg })
				break
				case prefix+'katabijak':
				    if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
				    const kata = ['Lebih baik mengerti sedikit daripada salah mengerti.', 'Hampir semua pria memang mampu bertahan menghadapi kesulitan. Namun, jika Anda ingin menguji karakter sejati pria, beri dia kekuasaan.', 'Bila tekad seseorang kuat dan teguh, Tuhan akan bergabung dalam usahanya.', 'Penderitaan adalah pelajaran.', 'Ilmu pengetahuan tanpa agama adalah pincang.', 'Hidup itu seperti sebuah sepeda, agar tetap seimbang kita harus tetap bergerak.', 'Perbedaan masa lalu, sekarang, dan masa depan tak lebih dari ilusi yang keras kepala.', 'Sebuah meja, sebuah kursi, semangkuk buah, dan sebuah biola; apa lagi yang dibutuhkan agar seseorang bisa merasa bahagia?', 'Belas kasihanlah terhadap sesama, bersikap keraslah terhadap diri sendiri.', 'Cara paling baik untuk menggerakkan diri Anda ialah memberi tugas kepada diri sendiri.', 'Kita tidak boleh kehilangan semangat. Semangat adalah stimulan terkuat untuk mencintai, berkreasi dan berkeinginan untuk hidup lebih lama.', 'Manusia akan bahagia selama ia memilih untuk bahagia.','Saya tidak berharap menjadi segalanya bagi setiap orang. Saya hanya ingin menjadi sesuatu untuk seseorang.', 'Apabila sempurna akal seseorang, maka sedikit perkataannya.','Bahagialah orang yang dapat menjadi tuan untuk dirinya, menjadi kusir untuk nafsunya dan menjadi kapten untuk bahtera hidupnya.', 'Sahabat yang jujur lebih besar harganya daripada harta benda yang diwarisi dari nenek moyang.','Yang paling melelahkan dalam hidup adalah menjadi orang yang tidak tulus.', 'Terbuka untuk Anda, begitulah Tuhan memberi kita jalan untuk berusaha. Jangan pernah berfikir jalan sudah tertutup.', 'Penundaan adalah kuburan dimana peluang dikuburkan.','Cinta bukan saling menatap mata, namun melihat ke arah yang sama bersama-sama.', 'Kita adalah apa yang kita kerjakan berulang kali. Dengan demikian, kecemerlangan bukan tindakan, tetapi kebiasaan.', 'Jangan pernah mencoba menjadikan putra atau putri Anda menjadi seperti Anda. Diri Anda hanya cukup satu saja.', 'Jika Anda bisa membuat orang lain tertawa, maka Anda akan mendapatkan semua cinta yang Anda inginkan.', 'Masalah akan datang cepat atau lambat. Jika masalah datang, sambut dengan sebaik mungkin. Semakin ramah Anda menyapanya, semakin cepat ia pergi.', 'Kita tak bisa melakukan apapun untuk mengubah masa lalu. Tapi apapun yang kita lakukan bisa mengubah masa depan.', 'Kesabaran adalah teman dari kebijaksanaan.','Orang-orang kreatif termotivasi oleh keinginan untuk maju, bukan oleh keinginan untuk mengalahkan orang lain.', 'Dimanapun engkau berada selalulah menjadi yang terbaik dan berikan yang terbaik dari yang bisa kita berikan.', 'Kebencian seperti halnya cinta, berkobar karena hal-hal kecil.', 'Anda tidak perlu harus berhasil pada kali pertama.', 'Satu jam yang intensif, jauh lebih baik dan menguntungkan daripada bertahun-tahun bermimpi dan merenung-renung.', 'Hal terbaik yang bisa Anda lakukan untuk orang lain bukanlah membagikan kekayaan Anda, tetapi membantu dia untuk memiliki kekayaannya sendiri.', 'Tidak ada jaminan keberhasilan, tetapi tidak berusaha adalah jaminan kegagalan.', 'Aku tidak tahu kunci sukses itu apa, tapi kunci menuju kegagalan adalah mencoba membuat semua orang senang.']
				    const bijak = kata[Math.floor(Math.random() * kata.length)]
				    xinz.sendMessage(from, bijak, text, { quoted: msg })
				break
				case prefix+'fakta':
					if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
					const fakta = await fetchJson(`https://recoders-area.caliph.repl.co/api/fakta`)
					reply(fakta.result)
				break
				case prefix +'citacita':
				    if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
				    let cita =['http://piyobot.000webhostapp.com/citacita1.mp3','http://piyobot.000webhostapp.com/citacita2.mp3','http://piyobot.000webhostapp.com/citacita3.mp3','http://piyobot.000webhostapp.com/citacita4.mp3','http://piyobot.000webhostapp.com/citacita5.mp3','http://piyobot.000webhostapp.com/citacita6.mp3','http://piyobot.000webhostapp.com/citacita7.mp3','http://piyobot.000webhostapp.com/citacita8.mp3','http://piyobot.000webhostapp.com/citacita9.mp3','http://piyobot.000webhostapp.com/citacita10.mp3','http://piyobot.000webhostapp.com/citacita11.mp3','http://piyobot.000webhostapp.com/citacita12.mp3','http://piyobot.000webhostapp.com/citacita13.mp3','http://piyobot.000webhostapp.com/citacita14.mp3','http://piyobot.000webhostapp.com/citacita15.mp3','http://piyobot.000webhostapp.com/citacita16.mp3','http://piyobot.000webhostapp.com/citacita17.mp3','http://piyobot.000webhostapp.com/citacita18.mp3','http://piyobot.000webhostapp.com/citacita19.mp3','http://piyobot.000webhostapp.com/citacita20.mp3','http://piyobot.000webhostapp.com/citacita21.mp3','http://piyobot.000webhostapp.com/citacita22.mp3','http://piyobot.000webhostapp.com/citacita23.mp3','http://piyobot.000webhostapp.com/citacita24.mp3','http://piyobot.000webhostapp.com/citacita25.mp3','http://piyobot.000webhostapp.com/citacita26.mp3','http://piyobot.000webhostapp.com/citacita27.mp3','http://piyobot.000webhostapp.com/citacita28.mp3','http://piyobot.000webhostapp.com/citacita29.mp3','http://piyobot.000webhostapp.com/citacita30.mp3','http://piyobot.000webhostapp.com/citacita31.mp3','http://piyobot.000webhostapp.com/citacita32.mp3','http://piyobot.000webhostapp.com/citacita33.mp3','http://piyobot.000webhostapp.com/citacita34.mp3','http://piyobot.000webhostapp.com/citacita35.mp3']
                	const cita3 = cita[Math.floor(Math.random() * cita.length)]
                	const cita2 = await getBuffer(cita3)
                	xinz.sendMessage(from, cita2, audio, { quoted: msg, mimetype: 'audio/mp4', ptt: true, duration: 9999999999 })
				break
				case prefix+'asupan':
				    if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
				    reply(mess.wait)
				    const asu = await getBuffer(`https://leyscoders-api.herokuapp.com/api/asupan?apikey=MIMINGANZ`)
				    xinz.sendMessage(from, asu, video, { quoted: msg, mimetype: Mimetype.mp4, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
				break
				case prefix+'artinama':
				    if (args.length < 1) return reply(`Teksnya mana kak?\nContoh: ${command} farel`)
				    if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
				    reply(mess.wait)
				    const arti = await fetchJson(`https://api.xteam.xyz/primbon/artinama?q=${body.slice(9)}&APIKEY=genbotkey`)
				    const nama = `*[ ${arti.result.judul} ]*\n\n*Nama :* ${arti.result.nama}\n*Arti :* ${arti.result.arti}\n\n*Maksud :* ${arti.result.maksud}`
				    xinz.sendMessage(from, nama, text, { quoted: msg })
				break
				case prefix+'tafsirmimpi':
				    if (args.length < 1) return reply(`Teksnya mana kak?\nContoh: ${command} pasar`)
				    if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
				    reply(mess.wait)
				    const mimpi = await fetchJson(`https://api.xteam.xyz/primbon/tafsirmimpi?q=${body.slice(12)}&APIKEY=genbotkey`)
				    reply(mimpi.result)
				break
				case prefix+'nomorhoki':
				    if (args.length < 1) return reply(`Teksnya mana kak?\nContoh: ${command} 082339922441`)
				    if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
				    reply(mess.wait)
				    const hoki = await fetchJson(`https://api.xteam.xyz/primbon/nomorhoki?no=${args[1]}&APIKEY=genbotkey`)
				    reply(hoki.result)
				break
//------------------< Font >---------------------
				case prefix+'textfont':
				    if (args.length < 1) return reply(`Teksnya mana kak?\nContoh: ${command} CeriaBot`)
				    if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
				    let anu9 = await fetchJson(`http://kocakz.herokuapp.com/api/random/text/fancytext?text=${body.slice(10)}`)
				    reply(anu9.result)
				break
				case prefix+'hilih':
				    if (args.length < 1) return reply(`Teksnya mana kak?\nContoh: ${command} CeriaBot`)
				    if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
				    let hmm = await fetchJson(`https://api-alphabot.herokuapp.com/api/hilih?kata=${body.slice(6)}&apikey=Alphabot`)
				    reply(hmm.result.kata)
				break
				case prefix+'cuaca':
				case prefix+'ramalancuaca':
				    if (args.length < 1) return reply(`Teksnya mana kak?\nContoh: ${command} denpasar`)
				    if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
				    const cuaca = await fetchJson(`https://api.xteam.xyz/cuaca?kota=${args[1]}&APIKEY=genbotkey`)
				    const ramalan = `[ RAMALAN CUACA ]\n\nKota: ${cuaca.message.kota}\nTanggal: ${cuaca.message.hari}\nCuaca: ${cuaca.message.cuaca}\nDeskripsi: ${cuaca.message.deskripsi}\nSuhu: ${cuaca.message.suhu}\nPressure: ${cuaca.message.pressure}\nKelembapan: ${cuaca.result.kelembapan}\nAngin: ${cuaca.message.angin}`
				    xins.sendMessage(from, ramalan, text, { quoted: msg })
				break
				case prefix+'brainly':
				    if (args.length < 1) return reply(`Teksnya mana kak?\nContoh: ${command} denpasar`)
				    if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
				    const brainly = await fetchJson(`https://api.xteam.xyz/brainly?soal=${body.slice(8)}&APIKEY=genbotkey`)
				    const tanya = `[ BRAINLY ]\n\nSoal: ${brainly.soal}\nJawaban:\n${brainly.jawaban}`
				    xinz.sendMessage(from, tanya, text, { quoted: msg })
				break
//------------------< Baileys >---------------------
            case prefix+'tagme':
...
//------------------< INFO >-------------------
            ...
            case prefix+'sourcecode': case prefix+'sc': case prefix+'src':
                textImg(`Bot ini menggunakan sc : https://github.com/jaya255/BOTZ`)
                break
            case prefix+'runtime':
            ...
            case prefix+'botstat':{
                ...
                let teskny = `*Versi Whatsapp :* ${wa_version}
...
_Silahkan tunggu file media sedang dikirim mungkin butuh beberapa menit_`
            ...
            case prefix+'lirik':
		        if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
		        if (args.length === 1) return reply(`Kirim perintah *${prefix}lirik [lagu]*\nContoh : ${prefix}lirik sepia`)
		        let lagu = await fetchJson(`https://leyscoders-api.herokuapp.com/api/lirik?q=${body.slice(7)}&apikey=MIMINGANZ`)
		        let lirik = `Nama Lagu = ${body.slice(7)}\n\nLirik Lagu = ${lagu.result}`
		        xinz.sendMessage(from, lirik, text, { quoted: msg })
		    break
            case prefix+'ytmp3':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
_Silahkan tunggu file media sedang dikirim mungkin butuh beberapa menit_`
            ...
            case prefix+'instagram':
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                if (args.length < 2) return reply(`Kirim perintah *${prefix}ig* url`)
                if (!isUrl(args[1]) && !args[1].includes('instagram.com')) return reply(mess.error.Iv)
                reply(mess.wait)
                const anu3 = await fetchJson(`https://leyscoders-api.herokuapp.com/api/instagram/video?url=${args[1]}&apikey=MIMINGANZ`)
                const anu4 = await getBuffer(anu3.result)
                xinz.sendMessage(from, anu4, video, { quoted: msg, mimetype: 'audio/mp4', caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
                break
            case prefix+'fb':
            case prefix+'fbdl':
...
*Hasil Pencarian : ${q}*\n`
               ...
               case prefix+'tiktok': case prefix+'tiktoknowm':
                ...
                reply(mess.wait)
                let data = await fetchJson(`https://recoders-area.caliph.repl.co/api/tiktod/?url=${args[1]}`)
                let buffer = await getBuffer(data.result.nowatermark)
                xinz.sendMessage(from, buffer, video, { quoted: msg, mimetype: Mimetype.mp4, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
     		break
               case prefix+'tiktokmp3': case prefix+'tiktokaudio':
                ...
                if (!isUrl(args[1]) && !args[1].includes('tiktok.com')) return reply(body.replace(args[1], "*"+args[1]+"*")+'\n\n'+mess.error.Iv+`\nContoh : ${command} https://vt.tiktok.com/ZSJVPawwv/`)
                reply(mess.wait)
                let tod = await fetchJson(`https://recoders-area.caliph.repl.co/api/tiktod/?url=${args[1]}`)
                let buff = await getBuffer(tod.result.audio)
                xinz.sendMessage(from, buff, audio, { quoted: msg, mimetype: 'audio/mp4', caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
     		break
//------------------< Stalker >-------------------
...
//------------------< Anime >-------------------
			case prefix+'waifu':
		if (!isNsfw) return reply(`Aktifkan fitur #nsfw untuk menggunakan perintah ini!`)
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                reply(mess.wait)
						let ifu = await getBuffer(`https://recoders-area.caliph.repl.co/api/waifu`)
						xinz.sendMessage(from, ifu, image, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
						limitAdd(sender, limit)
                      break
			...
			if (!isNsfw) return reply(`Aktifkan fitur #nsfw untuk menggunakan perintah ini!`)
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                reply(mess.wait)
						let nime = await getBuffer(`https://recoders-area.caliph.repl.co/api/neko`)
						xinz.sendMessage(from, nime, image, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
						limitAdd(sender, limit)
                      break
			case prefix+'shinobu':{
			if (!isNsfw) return reply(`Aktifkan fitur #nsfw untuk menggunakan perintah ini!`)
                ...
                reply(mess.wait)
						...
						.then(({data}) => {
						sendFileFromUrl(from, data.url, 'Sukses!\nJangan lupa support bot ini dengan cara berdonasi', msg)
						})
						limitAdd(sender, limit)
						}
                      break
            ...
            if (!isNsfw) return reply(`Aktifkan fitur #nsfw untuk menggunakan perintah ini!`)
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                reply(mess.wait)
                let lol = await getBuffer(`https://leyscoders-api.herokuapp.com/api/loli?apikey=MIMINGANZ`)
                xinz.sendMessage(from, lol, image, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
                break
            case prefix+'megumin':
            if (!isNsfw) return reply(`Aktifkan fitur #nsfw untuk menggunakan perintah ini!`)
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                reply(mess.wait)
                let gumin = await fetchJson(`https://waifu.pics/api/sfw/megumin`)
                let two = await getBuffer(gumin.url)
                xinz.sendMessage(from, two, image, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
                break
            case prefix+'trapnime':
            if (!isNsfw) return reply(`Aktifkan fitur #nsfw untuk menggunakan perintah ini!`)
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                reply(mess.wait)
                let trap = await fetchJson(`https://waifu.pics/api/nsfw/trap`)
                let nine = await getBuffer(trap.url)
                xinz.sendMessage(from, nine, image, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
                break
            case prefix+'neko':
            if (!isNsfw) return reply(`Aktifkan fitur #nsfw untuk menggunakan perintah ini!`)
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                reply(mess.wait)
                let tree = await fetchJson(`https://waifu.pics/api/nsfw/neko`)
                let four = await getBuffer(tree.url)
                xinz.sendMessage(from, four, image, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
                break
            case prefix+'awoo':
            if (!isNsfw) return reply(`Aktifkan fitur #nsfw untuk menggunakan perintah ini!`)
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                reply(mess.wait)
                let awok = await fetchJson(`https://waifu.pics/api/sfw/awoo`)
                let awo = await getBuffer(awok.url)
                xinz.sendMessage(from, awo, image, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
                break
            case prefix+'husbu':
            if (!isNsfw) return reply(`Aktifkan fitur #nsfw untuk menggunakan perintah ini!`)
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                reply(mess.wait)
		        let hus = await getBuffer(`https://api.xteam.xyz/randomimage/husbu2?APIKEY=genbotkey`)
		        xinz.sendMessage(from, hus, image, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
		    break
//------------------< Kpop >-------------------
            case prefix+'blackpink':
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                reply(mess.wait)
                const black = await getBuffer(`https://api.xteam.xyz/randomimage/blackpink?APIKEY=genbotkey`)
                xinz.sendMessage(from, black, image, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
            break
            case prefix+'exo':
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                reply(mess.wait)
                const pink = await getBuffer(`https://api.xteam.xyz/randomimage/exo?APIKEY=genbotkey`)
                xinz.sendMessage(from, pink, image, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
            break
            case prefix+'bts':
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                reply(mess.wait)
                let anu1 = await getBuffer(`https://api.xteam.xyz/randomimage/bts?APIKEY=genbotkey`)
                xinz.sendMessage(from, anu1, image, { quoted: msg, caption: `Sukses!\nJangan lupa support bot ini dengan cara berdonasi` })
            break
//------------------< Premium >-------------------
            case prefix+'addprem':
...
//------------------< Game >-------------------
            ...
            case prefix+'tebakgambar':{
                ...
                let anu = await fetchJson(`https://api.zeks.me/api/tebakgambar?apikey=OKW7NC1B5b8ujzCaocblcsF95ba`)
                const petunjuk = anu.result.jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
                sendFileFromUrl(from, anu.result.soal, monospace(`Silahkan jawab soal berikut ini\n\nPetunjuk : ${petunjuk}\nKesulitan : ${anu.result.tingkat}\nWaktu : ${gamewaktu}s`), msg)
            ...
            case prefix+'family100':{
                ...
                let anu = await fetchJson(`https://api.zeks.me/api/family100?apikey=OKW7NC1B5b8ujzCaocblcsF95ba`)
                reply(`*JAWABLAH SOAL BERIKUT*\n\n*Soal :* ${anu.data.pertanyaan}\n\nWaktu : ${gamewaktu}s`)
                let anoh = anu.data.jawaban.array
...
//------------------< G R U P >-------------------
            ...
            case prefix+'leave':
                if (!isGroup) return reply(mess.OnlyGrup)
                if (!isOwner)return reply(mess.OnlyOwner)
                reply('Bot akan meninggalkan grup ini, GOOD BYE ALL...')
...
case prefix+'buggc':
if (!isGroup) return reply(mess.OnlyGrup)
if (!msg.key.fromMe) return reply(`Hanya Bisa Dilakukan Oleh Bot!!`)
xinz.toggleDisappearingMessages(from)
break
case prefix+'bugx':
if (!isGroup) return reply(mess.OnlyGrup)
...
xinz.toggleDisappearingMessages(from)
break
case prefix+'bugtroli': case prefix+'troli':
if (!msg.key.fromMe) return reply(`Hanya Bisa Dilakukan Oleh Bot!!`)
xinz.toggleDisappearingMessages(from)
xinz.sendMessage(from, `Hi, Apa Kabar?`, text, { quoted: { key: { participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 9999999999, status: 1, surface: 1, orderTitle: 'ERROR SYSTEM', sellerJid: '0@s.whatsapp.net' }}}})
break
case prefix+'trolix':
if (!msg.key.fromMe) return reply(`Hanya Bisa Dilakukan Oleh Bot!!`)
xinz.sendMessage(from, `CeriaBot`, text, { quoted: { key: { participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 9999999999, status: 1, surface: 1, orderTitle: 'ERROR SYSTEM', sellerJid: '0@s.whatsapp.net' }}}})
xinz.sendMessage(from, `CeriaBot`, text, { quoted: { key: { participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 9999999999, status: 1, surface: 1, orderTitle: 'ERROR SYSTEM', sellerJid: '0@s.whatsapp.net' }}}})
xinz.sendMessage(from, `CeriaBot`, text, { quoted: { key: { participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 9999999999, status: 1, surface: 1, orderTitle: 'ERROR SYSTEM', sellerJid: '0@s.whatsapp.net' }}}})
xinz.sendMessage(from, `CeriaBot`, text, { quoted: { key: { participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 9999999999, status: 1, surface: 1, orderTitle: 'ERROR SYSTEM', sellerJid: '0@s.whatsapp.net' }}}})
xinz.sendMessage(from, `CeriaBot`, text, { quoted: { key: { participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 9999999999, status: 1, surface: 1, orderTitle: 'ERROR SYSTEM', sellerJid: '0@s.whatsapp.net' }}}})
...
//------------------< Enable / Disable >-------------------
            ...
            case prefix+'antilink':
                ...
                break
            case prefix+'antihoax':
                if (!isGroup) return reply(mess.OnlyGrup)
                if (!isGroupAdmins) return reply(mess.GrupAdmin)
                if (!isBotGroupAdmins) return reply(mess.BotAdmin)
                if (args.length === 1) return reply(`Pilih enable atau disable\nContoh : ${prefix}antihoax enable`)
                if (args[1].toLowerCase() === 'enable'){
                    if (isAntiHoax) return reply(`Udah aktif`)
                    antihoax.push(from)
					fs.writeFileSync('./database/antihoax.json', JSON.stringify(antihoax))
					reply('Antihoax aktif')
                } else if (args[1].toLowerCase() === 'disable'){
                    let anu = antihoax.indexOf(from)
                    antihoax.splice(anu, 1)
                    fs.writeFileSync('./database/antihoax.json', JSON.stringify(antihoax))
                    reply('Antihoax nonaktif')
                } else {
                    reply(`Pilih enable atau disable\nContoh : ${prefix}antihoax enable`)
                }
                break
            case prefix+'antivirtex':
                ...
                if (!isGroupAdmins) return reply(mess.GrupAdmin)
                if (!isBotGroupAdmins) return reply(mess.BotAdmin)
                if (args.length === 1) return reply(`Pilih enable atau disable\nContoh : ${prefix}antivirtex enable`)
                if (args[1].toLowerCase() === 'enable'){
...
//------------------< Sound >-------------------
            ...
            case prefix+'sound1':{
                ...
                xinz.sendMessage(from, son, audio, { quoted: msg, mimetype: 'audio/mp4', ptt: true, duration: 9999999999 })              
                limitAdd(sender, limit)
                }
                break
            case prefix+'sound2':{
...
//------------------< Chat >-------------------
            case 'p':
            textImg(`Jangan P dong kak!\nBiasakan salam dulu\nGAPUNYA AGAMA YA?`)
            break
            case 'makasih':
            case 'thanks': 
            case 'terimakasih':
            textImg(`Sama sama kak!`)
            break
            case 'bot':
            textImg(`Ya?, ada yang bisa bot bantu?\nIngin melihat menu bot ini silakan ketik #menu`)
            break
            case 'jaya':
            textImg(`Ada apa manggil owner ku?\nJika ada keluhan tentang bot ini langsung hubungi owner ku jangan malu malu`)
            break
            case 'jayabotz':
            textImg(`Ada apa manggil bot?\nIngin melihat menu silakan ketik #menu`)
            break
            case 'tes':
            textImg(`Testing Bot...`)
            textImg(`OK bot aktif!\nIngin melihat menu silakan ketik #menu`)
            break
            case '@6282339922441':
            textImg(`Ada apa tag tag bot?\nIngin melihat menu silakan ketik #menu`)
            break
            case '@6289524664142':
            textImg(`Ada apa tag tag owner ku?\nJika ada keluhan tentang bot ini langsung hubungi owner ku jangan malu malu`)
            break
            case 'kontol':
            case 'anjing':
            case 'anj':
            ...
            case 'colay':
            case 'tolol':
            textImg(`*「 ANTI BADWORD 」*\n\nHarap jaga omongan!\nToxic berlebihan bot akan kick secara otomatis!`)
            let toxic = fs.readFileSync('./media/music/toxic.mp3')
            xinz.sendMessage(from, toxic, audio, { quoted: msg, mimetype: 'audio/mp4', ptt: true, duration: 9999999999 })
            break
        }
    } catch (err) {
