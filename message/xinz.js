...
//------------------< Sticker / Tools >-------------------
            case prefix+'exif':{
				...
				await reply('Berhasil menyimpan exif\nMulai sekarang semua yang menggunakan fitur ${prefix}sticker memakai wm ini!')
            }
				break
            case prefix+'sticker':
            case prefix+'stiker':
...
//------------------< Text Marker >-------------------
            case prefix+'harta': case prefix+'hartatahta': case prefix+'tahta':{
                ...
                reply(mess.wait)
                xinz.sendImage(from, await getBuffer(`https://api.zeks.xyz/api/hartatahta?text=${args[1]}&apikey=apivinz`), '', msg).catch(() => reply(mess.error.api))
                limitAdd(sender, limit)
                }
                break
//------------------< Math Random >-------------------
...
//------------------< Random >---------------------
				...
				case prefix+'darkjokes': case prefix+'darkjoke': case prefix+'jokes': case prefix+'dark':
					...
					xinz.sendMessage(from, mami, image, { quoted: msg })
				break
				case prefix+'meme' case prefix+'memeindo':
				    if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
					reply(mess.wait)
				    let miymi = await fetchJson(`https://api.zeks.xyz/api/memeindo?apikey=OKW7NC1B5b8ujzCaocblcsF95ba`)
                    let meme = await getBuffer(miymi.result)
                    xinz.sendMessage(from, meme, image, { quoted: msg })
                    break
				case prefix+'pantun':
					if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
				...
				case prefix+'fakta':
					if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
					let fakta = await fetchJson(`https://recoders-area.caliph.repl.co/api/fakta`)
					reply(fakta.result)
				break
				case prefix+'katabijak':
					if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
					let kata = await fetchJson(`http://api.lolhuman.xyz/api/random/katabijak?apikey=genbotkey`)
					reply(kata.result)
				break
//------------------< Baileys >---------------------
            case prefix+'tagme':
...
*Hasil Pencarian : ${q}*\n`
               ...
               case prefix+'tiktok': case prefix+'tiktoknowm':
                ...
                xinz.sendMessage(from, buffer, video, { quoted: msg, mimetype: Mimetype.mp4 })
     		break
               case prefix+'tiktokmp3': case prefix+'tiktokaudio':
                ...
                xinz.sendMessage(from, buff, audio, { quoted: msg, mimetype: 'audio/mp4' })
     		break
//------------------< Stalker >-------------------
...
//------------------< Anime Menu >-------------------
			case prefix+'waifu':
                ...
                reply(mess.wait)
						...
						xinz.sendMessage(from, ifu, image, { quoted: msg })
						limitAdd(sender, limit)
                      break
			case prefix+'nekonime':
                ...
                reply(mess.wait)
						...
						xinz.sendMessage(from, nime, image, { quoted: msg })
						limitAdd(sender, limit)
                      break
			case prefix+'shinobu':{
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
            ...
            case prefix+'loli':
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                reply(mess.wait)
                let lol = await getBuffer(`https://recoders-area.caliph.repl.co/api/loli`)
                xinz.sendMessage(from, lol, image, { quoted: msg })
                      break
            case prefix+'husbu':
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
                reply(mess.wait)
		let hus = await fetchJson(`https://recoders-area.caliph.repl.co/api/husbu`)
		let husbu = await getBuffer(hus.url)
		xinz.sendMessage(from, husbu, image, { quoted: msg })
		break
//------------------< Premium >-------------------
            case prefix+'addprem':
...
//------------------< Game >-------------------
            ...
            case prefix+'family100':{
                ...
                let anu = await fetchJson(`https://leyscoders-api.herokuapp.com/api/family100?apikey=MIMINGANZ`)
